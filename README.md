...
```javascript
import arcsine from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-arcsine@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/random-array-arcsine/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-array-arcsine/actions/workflows/test.yml?query=branch:v0.2.2
