...
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-arcsine/tags). For example,

```javascript
import arcsine from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-arcsine@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/random-array-arcsine/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-array-arcsine/actions/workflows/test.yml?query=branch:v0.2.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-arcsine.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-arcsine/main
...
[deno-readme]: https://github.com/stdlib-js/random-array-arcsine/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-array-arcsine/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-array-arcsine/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-array-arcsine/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-array-arcsine/blob/esm/README.md
