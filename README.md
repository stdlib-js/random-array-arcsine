...
```javascript
import arcsine from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-arcsine@v0.0.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-arcsine@v0.0.0-esm/index.mjs';
```
